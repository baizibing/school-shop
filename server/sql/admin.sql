...
CREATE TABLE `admin` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci;

-- ----------------------------
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'admin', 'admin', '1');
INSERT INTO `admin` VALUES ('2', 'consumer', 'consumer', '2');
...
CREATE TABLE `banner` (
  ...
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '图片地址',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '活动地址',
  `start_time` datetime DEFAULT NULL COMMENT '活动开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '活动结束时间',
  `user_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '创建人',
  `active_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '活动名称',
  PRIMARY KEY (`id`)
...
-- Records of banner
-- ----------------------------
INSERT INTO `banner` VALUES ('1991x7h0qy5c000', '/api/public/images/img_192d36sxfgww000_lz.jpg', 'www.baidu.com', '2019-12-19 00:00:00', '2020-01-25 00:00:00', '1', '啦啦啦');
INSERT INTO `banner` VALUES ('19fy88tk4jwg000', '/api/public/images/img_19c7zc0ofa68000_9596719cd1ed81ff402e35f80b908dd1.jpg', 'https://element.eleme.cn/#/zh-CN/component/upload', '2019-12-17 00:00:00', '2019-12-18 00:00:00', '1', '无聊');
INSERT INTO `banner` VALUES ('19zl1rz23vr4000', '/api/public/images/img_19pkdy59fx4w000_u=422622651,90669900&fm=26&gp=0.jpg', 'https://element.eleme.cn/#/zh-CN/component/upload', '2021-04-14 00:00:00', '2021-05-14 00:00:00', '1', '苍山');
INSERT INTO `banner` VALUES ('1a1f7oh79dcw000', '/api/public/images/img_1aedd64yzbs0000_u=3313704117,3624683545&fm=26&gp=0.jpg', 'https://element.eleme.cn/#/zh-CN/component/upload', '2021-04-14 00:00:00', '2021-05-14 00:00:00', '1', '玉龙雪山');
INSERT INTO `banner` VALUES ('1akx5psztaf4000', '/api/public/images/img_1ah68ibtyr7k000_下载.jpg', 'https://element.eleme.cn/#/zh-CN/component/upload', '2021-04-14 00:00:00', '2021-05-14 00:00:00', '1', '洱海');
...
CREATE TABLE `category` (
  `id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '分类ID',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '分类名称',
  `parent_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '父级类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES ('19yld8tnz7eo000', '奶油饼干', '1eoquu0ywv28000');
INSERT INTO `category` VALUES ('1aoyhn09svc0000', '看书', '63syejf8gno0000');
INSERT INTO `category` VALUES ('1b33r94r4ork000', '拿铁', '17obw0oo39vg000');
...
-- Records of shopcar
-- ----------------------------
INSERT INTO `shopcar` VALUES ('2', '24', '1', '34');
INSERT INTO `shopcar` VALUES ('2', '23', '4', '5');
INSERT INTO `shopcar` VALUES ('2', '21', '5', '1');
INSERT INTO `shopcar` VALUES ('2', '32', '6', '1');
INSERT INTO `shopcar` VALUES ('2', '22', '7', '2');
INSERT INTO `shopcar` VALUES ('5', '21', '28', '2');
INSERT INTO `shopcar` VALUES ('5', '8', '27', '1');
INSERT INTO `shopcar` VALUES ('3', '12', '26', '1');
INSERT INTO `shopcar` VALUES ('3', '13', '25', '1');
INSERT INTO `shopcar` VALUES ('3', '19', '24', '2');
INSERT INTO `shopcar` VALUES ('3', '20', '23', '3');
INSERT INTO `shopcar` VALUES ('3', '24', '22', '10');
INSERT INTO `shopcar` VALUES ('2', '34', '15', '1');
INSERT INTO `shopcar` VALUES ('3', '23', '21', '3');
INSERT INTO `shopcar` VALUES ('3', '22', '20', '5');
INSERT INTO `shopcar` VALUES ('3', '21', '19', '5');
INSERT INTO `shopcar` VALUES ('3', '18', '29', '1');
INSERT INTO `shopcar` VALUES ('3', '8', '30', '3');
INSERT INTO `shopcar` VALUES ('3', '10', '31', '5');
INSERT INTO `shopcar` VALUES ('3', '7', '32', '1');
INSERT INTO `shopcar` VALUES ('5', '19', '33', '1');
INSERT INTO `shopcar` VALUES ('5', '24', '34', '1');
...
INSERT INTO `typeparent` VALUES ('1eoquu0ywv28000', '曲奇饼');
INSERT INTO `typeparent` VALUES ('17obw0oo39vg000', '星巴克');
INSERT INTO `typeparent` VALUES ('18onmu1vouio000', '日用百货-双11大促销活动');
...
CREATE TABLE `user` (
  ...
  `avatar` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '用户头像',
  `nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户昵称',
  `sex` enum('0','1') CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '性别',
  `age` int(3) DEFAULT NULL COMMENT '年龄',
  `phone` varchar(11) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '手机号',
  `wechat` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '微信号',
...
INSERT INTO `user` VALUES ('6', '12345qwer', null, null, null, null, '15036058474', null, null, '2019-12-19 16:16:03');
INSERT INTO `user` VALUES ('7', 'qwe123', null, null, null, null, '15023542345', null, null, '2019-12-19 16:18:02');
INSERT INTO `user` VALUES ('8', 'qwr234', null, null, null, null, '13849492356', null, null, '2019-12-19 16:34:25');
INSERT INTO `user` VALUES ('9', '123qwe', null, null, null, null, '15023457235', null, null, '2019-12-20 15:28:10');
...
CREATE TABLE `wares` (
  ...
  `cover` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '封面',
  `pictures` varchar(2000) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '照片',
  `detail` text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT '详情',
  ...
  `specs` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '规格',
  `category_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '分类ID',
  `label` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '标签',
  `status` enum('0','1') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '商品状态',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `type_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '父级类型',
  PRIMARY KEY (`id`)
